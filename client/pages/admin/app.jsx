...
const ExportData = require('./export/index.jsx');
const ChangePassword = require('./change-password/index.jsx');
// const Feed = require('./feeds/index.jsx');
    ...
    <Router>
        <div>
            ...
            <Switch>
                ...
                {/* route for xml feed page
                <Route path="/admin/feeds" component={Feed} />
                */}
            </Switch>
            {/*<Footer />*/}
        </div>
